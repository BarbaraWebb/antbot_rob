...
This CA system was abandoned and the reader should note that the code is still on the robot, though commented and missing some
sections. The menu option on the robot was repurposed to allow easy debugging of other procedures.
