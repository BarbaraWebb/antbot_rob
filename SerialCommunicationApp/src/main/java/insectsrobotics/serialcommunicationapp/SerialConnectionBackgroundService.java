                ...
                public void onNewMessage(String msg) {
                    ...
                    if (msg.contains("Serial")){
                        ...
                        if (msg.contains("Move")){
                            ...
                            broadcast.broadcastTypeOfMovement("m");
                        } else if (msg.contains("Turn")){
                            msg = msg.replace("Turn", "");
                            broadcast.broadcastTypeOfMovement("t");
                        } else if (msg.equals("h")){
                            broadcast.broadcastTypeOfMovement("h");
                        } else if (msg.contains("Drive")){
                            broadcast.broadcastTypeOfMovement("g");
                        }
                    ...
                    } else if (msg.equals("learn")){
                        broadcast.broadcastLearnImageCommand();
                        //serialInOutManager.setImageLearned(true);
                    } else if (msg.equals("calc")){
                        Log.e(TAG,"broadcast Calc Command");
                        broadcast.broadcastCalculateErrorCommand();
                    } else if (msg.equals("minimum")){
                        broadcast.broadcastTurnToMinimumCommand();
                    } else if (msg.contains("String")){
                        msg = msg.replace("String","");
                        broadcast.broadcastStringToVN(msg);
                    }
                }
