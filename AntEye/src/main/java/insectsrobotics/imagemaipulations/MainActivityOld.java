...
//
// This is a backup copy of MainActivity.java this version should be
// known working. The MainActivity.java file is being cleaned and
// refactored. This copy is kept for ease sake, you will need to
// revise to the commit just before this to get the fully working system.
//
...
public class MainActivityOld extends Activity implements CvCameraViewListener2 , BroadcastValues, SensorEventListener{
